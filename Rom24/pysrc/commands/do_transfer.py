...
interp.register_command(interp.cmd_type('teleport', do_transfer, merc.POS_DEAD, merc.L5, merc.LOG_ALWAYS, 1))
interp.register_command(interp.cmd_type('transfer', do_transfer, merc.POS_DEAD, merc.L5, merc.LOG_ALWAYS, 1))
